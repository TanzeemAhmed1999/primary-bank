...
func TestUpdateAccount(t *testing.T) {
	...
	require.WithinDuration(t, account1.CreatedAt.Time, updatedAcc.CreatedAt.Time, time.Second)
}
...
func TestDeleteAccount(t *testing.T) {
	...
	deletedAcc, err := testQueries.GetAccount(context.Background(), account1.ID)
	require.Error(t, err)
